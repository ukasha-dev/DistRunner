// <copyright file="GetFiles_Should.cs" company="Your Company">
...
namespace DISTRUNNER.Infrastructure.UnitTests.DirectoryProviderTests;

[TestFixture]
public class GetFiles_Should
{
    [Test]
