// <copyright file="GetAssemblyFromFile_Should.cs" company="Your Company">
...
namespace DISTRUNNER.Infrastructure.UnitTests.ReflectionProviderTests;

[TestFixture]
public class GetAssemblyFromFile_Should
{
    [Test]
