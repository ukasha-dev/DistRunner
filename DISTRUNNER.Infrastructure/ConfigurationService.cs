// <copyright file="ConfigurationService.cs" company="Your Company">
...
public sealed class ConfigurationService
{
    ...
    private static IConfigurationRoot InitializeConfiguration()
    {
        ...
        var settingsFile =
            filesInExecutionDir.FirstOrDefault(x => x.Contains("DISTRUNNERSettings") && x.EndsWith(".json", StringComparison.Ordinal));
