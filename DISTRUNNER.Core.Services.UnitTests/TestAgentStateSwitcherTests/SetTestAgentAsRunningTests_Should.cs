// <copyright file="SetTestAgentAsRunningTests_Should.cs" company="Your Company">
...
namespace DISTRUNNER.Core.Services.UnitTests.TestAgentStateSwitcherTests;
...
public class SetTestAgentAsRunningTests_Should
{
    ...
    public async Task UpdateTestAgentStatusToRunningTests_When_CurrentTestAgentStatusIs(TestAgentStatus status)
    {
        ...
        // Act
        await _testAgentStateSwitcher.SetTestAgentAsRunningTestsAsync(FixtureFactory.Create().Create<string>()).ConfigureAwait(false);
    ...
    public async Task NotUpdateTestAgentStatus_When_TestAgentForCurrentMachineIsInRunningTestsStatus()
    {
        ...
        // Act
        await _testAgentStateSwitcher.SetTestAgentAsRunningTestsAsync(testAgents.First().AgentTag).ConfigureAwait(false);
