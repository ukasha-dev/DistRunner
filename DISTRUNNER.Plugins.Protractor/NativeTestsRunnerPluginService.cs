// <copyright file="NativeTestsRunnerPluginService.cs" company="Your Company">
...
using DISTRUNNER.Plugins.Contracts;
using DISTRUNNER.Plugins.Protractor.Model;
using DISTRUNNER.Server.Models;

namespace DISTRUNNER.Plugins.Protractor;
...
framework: 'jasmine',
  ...
  onPrepare: function() {
    ...
    private readonly string _deleteItemsFilePath = Path.Combine(Path.GetTempPath(), "protractorDISTRUNNERDeleteItemsPostExecute.txt");
