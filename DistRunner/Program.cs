...
using DISTRUNNER.Core.Model.Exceptions;
using DISTRUNNER.Core.Model.Settings;
using DISTRUNNER.Core.Services;
using DISTRUNNER.Infrastructure;
using DISTRUNNER.Model;
using DISTRUNNER.Server.Client.Clients;
...
public static class Program
{
    ...
    public static void Main(string[] args)
    {
        try
        {
            ...
            if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
            {
                ...
                Console.Clear();
                Console.Title = "DISTRUNNER Distributed Test Runner- Your Company Test Automation Framework";
        ...
        Console.WriteLine();
        Console.WriteLine(" Created by Your Company");
        Console.WriteLine(" http://Your Company.solutions");
    ...
    private static int InitializeServer()
    {
        try
        {
            ...
            processProvider.StartProcessAndWaitToFinish("DISTRUNNERserver", $"{GetExecutingAssemblyFolder()}", string.Empty, 0);
            return 1;
        }
        catch (Exception e)
        {
    ...
    private static ILogger ConfigureLogger()
    {
        ...
        if (loggingSettings != null && loggingSettings.IsEnabled)
        {
            ...
            resultLogger = loggerFactory.CreateLogger("Your Company");
        }
