...
namespace GenerateLoadTestProjects
{
    public class Program
    {
        ...
        private static void GenerateLoadTestsNUnit()
        {
            ...
            var deployLocation = @"C:\SourceCode\DISTRUNNER\NUnitLoadTest\";
        ...
        ////    var deployLocation = @"D:\SourceCode\DISTRUNNER\LoadTestsProject.NUnit\";
        ...
        ////    var numberOfTestFiles = 2;
        ////    var numberOfTests = 1000;
        ////    var deployLocation = @"D:\SourceCode\DISTRUNNER\LoadTestsProject";
        ////    for (var i = 1; i < numberOfTestFiles; i++)
        ////    {
        ////        var sb = new StringBuilder();
        ////        sb.AppendLine("using System;");
        ...
        ////            sb.AppendLine("                 userName.SendKeys(\"yourcompany\");");
        ...
        ////            sb.AppendLine("                 email.SendKeys(\"aangelov@Your Company.solutions\");");
        ...
        ////            sb.AppendLine("                 ccname.SendKeys(\"Your Name\");");
