...
using System.IO;
using DISTRUNNER.Plugins.MSTest;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        string file1 = File.ReadAllText(@"C:\DISTRUNNER-tests-results\corrupted.trx");
        ...
        var testCases = nativeTestsRunnerTestCasesPluginService.ExtractAllTestCasesFromTestLibrary(@"C:\DISTRUNNER-tests\SmallMSTestTestProject.dll");

        foreach (var testCase in testCases)
        {
            Console.WriteLine(testCase.FullName);
        }
        ////string filePath1 = File.ReadAllText(@"C:\Users\aangelov\Downloads\DISTRUNNER_Fixes\_nunit_reports_\tmpCD7E.tmp");
        ////string filePath2 = File.ReadAllText(@"C:\Users\aangelov\Downloads\DISTRUNNER_Fixes\_nunit_reports_\tmpCD8F.tmp");
